...
class DatabaseMessagingService {
  ...
  static Future<int> getTotalUnreadCount() async {
    try {
      ...
      for (final conversation in conversations) {
        // Use the conversation's helper method to get the correct unread count for current user
        totalUnread += conversation.getUserUnreadCount(currentUserId);
      }
  ...
  // Client-side last message update removed. DB trigger manages last message and unread counts.
